...
public class ApiShoppinglistConstants {
    // --------------- GENERAL CONSTANTS -------------------------------------------------------------
    public static final String API_NAME = "Shoppinglist Controller [Version 1] API Documentation";
    public static final String API_DESCRIPTION = "Management of the main functionalities related with the shoppinglist entity";
    // --------------- URL CONSTANTS -----------------------------------------------------------------
    public static final String BASE_URL = "/api/shoppinglist/v1";
    public static final String GET_ALL_V1 = "/all";
    public static final String CREATE_V1 = "/create";
    public static final String DELETE_V1 = "/delete/{idShoppinglist}";
    public static final String UPDATE_V1 = "/update";
    public static final String FILTER_V1 = "/filter";
    public static final String GET_DETAILS_V1 = "/{idShoppinglist}/details";
    public static final String UPDATE_IS_ACTIVE_V1 = "/{idShoppinglist}/update/isActive";
    public static final String DELETE_LOGIC_V1 = "/{idShoppinglist}/delete/logic";
    public static final String ADD_SHOPPINGLIST_ITEM_V1 = "/{idShoppinglist}/addShoppinglistItem";
    public static final String UPDATE_TOTAL_PRICE_V1 = "/{idShoppinglist}/updateTotalPrice";
